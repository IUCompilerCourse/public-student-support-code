...
(provide interp_Lwhile_proxy interp_Lwhile_proxy-class)

(define interp_Lwhile_proxy-class
  (class interp_Lwhile_prime-class
    (super-new)
...
(define (interp_Lwhile_proxy p)
  (send (new interp_Lwhile_proxy-class) interp-program p))
